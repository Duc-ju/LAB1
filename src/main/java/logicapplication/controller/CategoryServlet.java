 ...
 */
@WebServlet("/category")
public class CategoryServlet extends HttpServlet { //Handle filter by category
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Book> books = new BookDAO().getBooksByCategoryID(categoryID);
		List<Category> categories = new CategoryDAO().getCategories();
		request.setAttribute("selectedCatelogyID", categoryID);
